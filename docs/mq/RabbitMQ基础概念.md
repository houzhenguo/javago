...
![rabbitmq基础使用](./images/rabbitmq-base.png)
# RabbitMQ的概念使用
...
![RabbitMQ的核心消息模型](./images/rabbitmq-core-model.jpg)
...
![RabbitMQ交换器](./images/rabbitmq-exchange.jpg)
...
![RabbitMQBindingkey](./images/rabbitmq-bindingkey.jpg)
...
![消息队列的运转过程](./images/rabbitmq-msg-handle.jpg)
...
![direct 类型交换器](./images/rabbitmq-exchange-direct.jpg)
...
![topic 类型交换器](./images/rabbitmq-exchange-topic.jpg)
